{
  ...
  "items": [
    {
      "exception": {
        "localizedMessage": "duplicate value found: Email__c duplicates value on record with id: a0L5j000000LdzX DUPLICATE_VALUE",
        "cause": null,
        "message": "duplicate value found: Email__c duplicates value on record with id: a0L5j000000LdzX DUPLICATE_VALUE",
        "stackTrace": [
          {
          ...
          },
          {
            "fileName": null,
            "methodName": "execute",
            "className": "org.mule.extension.salesforce.internal.operation.core.CreateOperation\$create\$MethodComponentExecutor_salesforce_sapi__2_",
            "nativeMethod": false,
            "lineNumber": -1
          },
          {
      ...
      "message": "duplicate value found: Email__c duplicates value on record with id: a0L5j000000LdzX",
      "payload": {
        "success": false,
        "id": null,
        "errors": [
