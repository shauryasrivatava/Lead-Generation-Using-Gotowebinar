{
  ...
  "items": [
    {
      "exception": {
        "localizedMessage": "duplicate value found: Email__c duplicates value on record with id: a0L5j000000LeNO DUPLICATE_VALUE",
        "cause": null,
        "message": "duplicate value found: Email__c duplicates value on record with id: a0L5j000000LeNO DUPLICATE_VALUE",
        "stackTrace": [
          {
      ...
      "message": "duplicate value found: Email__c duplicates value on record with id: a0L5j000000LeNO",
      "payload": {
        "success": false,
        "id": null,
        "errors": [
